...
def main():
    ...
    if(True):
        ...
        print('raw_train_label: ', raw_train_labels.shape)
        print('pred_output_train_: ', pred_output_train_lr)
        print('wt: ', weights_lr.shape)


        print ("Training Set Accuracy - LR: ", accuracy(raw_train_labels, one_hot_encoding(pred_output_train_lr)))

        pred_output_valid_lr = np.dot(add_ones(validation_data_input), weights_lr)

        print ("Validation Set Accuracy - LR: ", accuracy(raw_valid_labels, one_hot_encoding(pred_output_valid_lr)))

        pred_output_test_lr = np.dot(add_ones(test_dataset), weights_lr)

        print ("Test Set Accuracy - LR: ", accuracy(raw_test_labels, one_hot_encoding(pred_output_test_lr)))

        pred_output_usps_lr = np.dot(add_ones(validation_usps), weights_lr)
        print ("USPS Accuracy - LR: ", accuracy(validation_usps_label, one_hot_encoding(pred_output_usps_lr)))
        print('------------------------------------------------------------------------------------------')
    ...
    if(False):
        ...
        print('Performance on USPS: ', usps_accuracy_nn)
